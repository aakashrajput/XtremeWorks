                        ...
                        <div class="collapse navbar-collapse mean-menu" id="navbarSupportedContent">
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li class="nav-item">
                                            <a href="/user/profile" class="nav-link">Profile Settings</a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="/user/wallet" class="nav-link">Wallet</a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="single-blog.html" class="nav-link" href="{{ route('associate.logout') }}"
                                ...
                                <li class="nav-item"><a href="" class="nav-link">Wallet Balance: <span style="color:green;">20$</span></a></li>
                            </ul>
