                    ...
                    <nav class="navbar navbar-expand-md navbar-light">
                        ...
                        <div class="collapse navbar-collapse mean-menu" id="navbarSupportedContent">
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item">
                                <a href="contact.html" class="nav-link">Welcome: <img src="https://cdn.dribbble.com/users/35633/screenshots/5478741/mathieubeaulieu_id_halloween07_small_1x.png" alt="user avatar">{{Auth::user()->username}}</a>
                                </li>
                            </ul>
