                        ...
                        <div class="collapse navbar-collapse mean-menu" id="navbarSupportedContent">
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li class="nav-item">
                                            <a href="projects.html" class="nav-link">Explore Jobs</a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="single-projects.html" class="nav-link">Post Jobs</a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a href="index-2.html#" class="nav-link">
                                        <img src="https://picoworkers.com/im/web/profile_no_image.gif" alt="user avatar" width="30px">&nbsp;<span style="color:#2fd88a;">{{Auth::user()->username}}</span>
                                        <i class="fa fa-angle-down"></i>
                                    </a>
                                    <ul class="dropdown-menu">
                                        <li class="nav-item">
                                            <a href="blog.html" class="nav-link">Profile Settings</a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="/user/wallet" class="nav-link">Wallet</a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="single-blog.html" class="nav-link">Logout</a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="nav-item"><a href="about.html" class="nav-link">Wallet Balance: <span style="color:green;">20$</span></a></li>
                            </ul>
