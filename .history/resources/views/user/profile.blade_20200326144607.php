            ...
            <div class="col-lg-4 col-md-6">
                <div class="single-contact-box">
                    ...
                    <h3>User Name: {{Auth::user()->username}}</h3>
                        <p>Wallet Balance: 20$ <br> Under Review Balance: 20$</p>
                        <li>Wallet Balance: 20$</li>
                        <li>Under Review Balance: 20$</li>
                        <li>Task Completed: 120</li>
                        <p>Task Completed: 120</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
...
<section class="contact-area pb-100">
    <div class="container">
        ...
        <div class="row">
                ...
                <div class="contact-form">
                    ...
                    <form id="contactForm">
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <input type="email" name="email" class="form-control" placeholder="New Password">
                                </div>
                            </div>
                            <div class="col-lg-12">
            ...
            <div class="col-lg-6">
                <div class="contact-form">
                    <center><h4>Submit Your Paypal Email</h4></center>
                    <form id="contactForm">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <input type="text" name="name" class="form-control" placeholder="Enter Paypal Email">
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <button type="submit" class="default-btn">Submit Paypal</button>
                            </div>
                        </div>
                    </form>
                </div>
