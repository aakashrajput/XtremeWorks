                    ...
                    <nav class="navbar navbar-expand-md navbar-light">
                        ...
                        <div class="collapse navbar-collapse mean-menu" id="navbarSupportedContent">
                            <ul class="navbar-nav">
                                <li class="nav-item">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li class="nav-item">
                                            <a href="index-2.html" class="nav-link active">Marketing Home</a>
                                        </li>
                                        <li class="nav-item">
                            ...
                            <div class="others-options saas-option">
                                <a class="saas-nav-btn" href="index-2.html#">
                                    Free Analysis
                                </a>
                            </div>
                        </div>
						...
						<div class="row">
							<div class="col-lg-12 col-md-12">
								<div class="hero-content">
                                    <span>Marketing is the core vision</span>
									<h1>Marketing is More Than a Buzzword</h1>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolet, consectetur adipiscing  seore suspendisse ultrices gravidaLorem ipsum dolor sit amet, consectetur adipisicing elit.</p>
                                    <div class="marketing-btn">
                                        <a href="index-2.html#" class="marketing-btn-one">Discover More</a>
                                        <a href="https://www.youtube.com/watch?v=bk7McNUjWgw" class="video-btn popup-youtube"><span>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-12">
                        <div class="we-do-content-area">
                            ...
                            <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Blanditiis fugiat odio reprehenderit repellendus ea unde in explicabo incidunt Vitae, expedita laboriosam quaerat nemo possimus consequuntur numquam explicabo incidunt blanditiis magnam, nihil eum!</p>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim.</p>
                            <div class="we-btn">
                                <a href="index-2.html#" class="we-btn-one">Discover More</a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="fun-facts-content">
                            <h3>
                                <span class="odometer" data-count="16">00</span><span class="sign-icon">k</span>
                            </h3>
                            <p>Expert Employee</p>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="fun-facts-content">
                            <h3>
                                <span class="odometer" data-count="130">00</span><span class="sign-icon">+</span>
                            </h3>
                            <p>Ultimate Growth</p>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="fun-facts-content">
                            <h3>
                                <span class="odometer" data-count="20">00</span><span class="sign-icon">k</span>
                            </h3>
                            <p>Global Customer</p>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="fun-facts-content">
                            <h3>
                                <span class="odometer" data-count="210">00</span><span class="sign-icon">+</span>
                            </h3>
                            <p>Expert Employee</p>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-md-12">
                        <div class="history-content-area">
                            ...
                            <div class="history-btn">
                                <a href="index-2.html#" class="history-btn-one">Discover More</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-12">
                        <div class="needs-area-content">
                            ...
                            <div class="needs-btn">
                                <a href="index-2.html#" class="needs-btn-one">Discover More</a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="project-title">
                    ...
                    <div class="project-btn">
                        <a href="single-projects.html" class="project-btn-one">Visit Gallery</a>
                    </div>
                </div>
                    ...
                    <div class="col-lg-6 col-md-12">
                        <div class="provide-area-content">
                            ...
                            <form class="provide-form">
                                <input type="email" class="input-newsletter" placeholder="Enter email adddress here">
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="footer-area-content">
                            <img src="assets/img/logo/logo-2.png" alt="image">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="single-footer-widget">
                            ...
                            <ul class="footer-quick-links">
                                <li>
                                    <a href="index-2.html#">Support Center</a>
                                </li>
                                <li>
                                    <a href="index-2.html#">Popular Campaign</a>
                                </li>
                                <li>
                                    <a href="index-2.html#">Customer Support</a>
                                </li>
                                <li>
                                    <a href="index-2.html#">Copyright</a>
                                </li>
                                <li>
                                    <a href="index-2.html#">Latest News</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="single-footer-widget">
                            ...
                            <ul class="footer-quick-links">
                                <li>
                                    <a href="index-2.html#">Speaker requests</a>
                                </li>
                                <li>
                                    <a href="index-2.html#">Images and b-roll</a>
                                </li>
                                <li>
                                    <a href="index-2.html#">Social media directories</a>
                                </li>
                                <li>
                                    <a href="index-2.html#">Permissions</a>
                                </li>
                                <li>
                                    <a href="index-2.html#">Press inquiries</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="single-footer-widget">
                            ...
                            <ul class="social-list">
                                <li>
                                    <a href="index-2.html#" class="facebook" target="_blank">
                                        <i class="fab fa-facebook-f"></i>
                                    </a>
                                </li>
                                <li>
                                    <a href="index-2.html#" class="twitter" target="_blank">
                                        <i class="fab fa-twitter"></i>
                                    </a>
                                </li>
                                <li>
                                    <a href="index-2.html#" class="linkedin" target="_blank">
                                        <i class="fab fa-linkedin-in"></i>
                                    </a>
                                </li>
                                <li>
                                    <a href="index-2.html#" class="instagram" target="_blank">
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-6 col-sm-6 col-md-6">
                            <p>
                                ...
                                2020 Exto. All Rights Reserved by 
