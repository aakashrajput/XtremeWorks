						...
						<div class="row">
							<div class="col-lg-12 col-md-12">
								<div class="hero-content">
                                    <span>The Work From Home Portal</span>
									<h1>XtremeWorks with Big Earnings</h1>
                                    <p>XtremeWorks is an online marketplace that connects Freelancers around the globe with business owners.</p>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-12">
                        <div class="we-do-content-area">
                            ...
                            <h3>We Provide Work From Home tasks to our customers</h3>
                            <p>XtremeWorks allow you to work from home by completing various tasks hosted by business owners across the globe.</p>
                            <p>The tasks provided here are so small that you can complete it in a matter of time and get paid for it.</p>
                            <div class="we-btn">
        ...
        <section class="achieved-section ptb-100">
            <div class="container">
                <div class="achieved-title">
                    ...
                    <h3>We have over 150+ legit jobs by some huge companies</h3>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="fun-facts-content">
                            <h3>
                                <span class="odometer" data-count="530">00</span><span class="sign-icon">+</span>
                            </h3>
                            <p>Small Jobs Daily</p>
                        </div>
                    </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 col-md-12">
                        <div class="history-content-area">
                            ...
                            <h3>Modern solutions & different Live experience during the work</h3>
