                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 col-md-12">
                        <div class="about-content-area">
                            <span>About us</span>
                            <h3>XtremeWorks</h3>
                            <p>Picoworkers is an online marketplace that connects Freelancers around the world with business owners. Businesses who need other people to help them to support their work come to Picoworkers. Here they can hire workers for easy and quick jobs.</p>
                            ...
                            <div class="about-btn">
                                <a href="about.html#" class="about-btn-one">Discover More</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-12">
                        <div class="we-do-content-area">
                            ...
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim venia.</p>
                            <div class="we-btn">
                                <a href="about.html#" class="we-btn-one">Discover More</a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="single-team-member">
                            ...
                            <div class="member-content">
                                <h3>
                                    <a href="about.html#">White Amlington</a>
                                </h3>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="single-team-member">
                            ...
                            <div class="member-content">
                                <h3>
                                    <a href="about.html#">Agaton Ronald</a>
                                </h3>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="single-team-member">
                            ...
                            <div class="member-content">
                                <h3>
                                    <a href="about.html#">Mexwell White</a>
                                </h3>
