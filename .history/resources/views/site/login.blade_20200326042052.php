                    ...
                    <nav class="navbar navbar-expand-md navbar-light">
                        ...
                        <div class="collapse navbar-collapse mean-menu" id="navbarSupportedContent">
                            ...
                            <div class="others-options saas-option">
                                <a class="saas-nav-btn" href="login.html#">
                                    Free Analysis
                                </a>
                            </div>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="single-footer-widget">
                            ...
                            <ul class="footer-quick-links">
                                <li>
                                    <a href="login.html#">Support Center</a>
                                </li>
                                <li>
                                    <a href="login.html#">Popular Campaign</a>
                                </li>
                                <li>
                                    <a href="login.html#">Customer Support</a>
                                </li>
                                <li>
                                    <a href="login.html#">Copyright</a>
                                </li>
                                <li>
                                    <a href="login.html#">Latest News</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="single-footer-widget">
                            ...
                            <ul class="footer-quick-links">
                                <li>
                                    <a href="login.html#">Speaker requests</a>
                                </li>
                                <li>
                                    <a href="login.html#">Images and b-roll</a>
                                </li>
                                <li>
                                    <a href="login.html#">Social media directories</a>
                                </li>
                                <li>
                                    <a href="login.html#">Permissions</a>
                                </li>
                                <li>
                                    <a href="login.html#">Press inquiries</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="single-footer-widget">
                            ...
                            <ul class="social-list">
                                <li>
                                    <a href="login.html#" class="facebook" target="_blank">
                                        <i class="fab fa-facebook-f"></i>
                                    </a>
                                </li>
                                <li>
                                    <a href="login.html#" class="twitter" target="_blank">
                                        <i class="fab fa-twitter"></i>
                                    </a>
                                </li>
                                <li>
                                    <a href="login.html#" class="linkedin" target="_blank">
                                        <i class="fab fa-linkedin-in"></i>
                                    </a>
                                </li>
                                <li>
                                    <a href="login.html#" class="instagram" target="_blank">
