                ...
                <div class="container">
                    <nav class="navbar navbar-expand-md navbar-light">
                        ...
                        <div class="collapse navbar-collapse mean-menu" id="navbarSupportedContent">
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li class="nav-item">
                                            <a href="single-projects.html" class="nav-link">Post a Job</a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="nav-item">
                            ...
                            <a href="/user/login" style="color:white; font-weight:bold;">LogIn</a>
                            <div class="others-options saas-option">
                                <a class="saas-nav-btn" href="/user/register">
                                    SignUp
                                </a>
                            </div>
                        </div>
